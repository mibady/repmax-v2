...
export default function HomePage() {
  return (
    <div className="bg-background-dark overflow-x-hidden antialiased text-white selection:bg-primary/30">
      {/* Sticky Navigation */}
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-background-dark/90 backdrop-blur-md">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a className="text-sm font-medium text-text-grey hover:text-white transition-colors" href="#features">Features</a>
            <a className="text-sm font-medium text-text-grey hover:text-white transition-colors" href="#how-it-works">How it Works</a>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <div className="flex-1 w-full max-w-[440px] group">
              <div className="relative">
                ...
                <div className="relative flex flex-col overflow-hidden rounded-xl border border-white/10 bg-[#0A0A0A] shadow-2xl">
                  ...
                  <div className="relative h-64 w-full overflow-hidden">
                    ...
                    <Image
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuDZwbt_hybye6anPNSVs0D1vq_domsQOEepvg2A9FIVCX4kSTWHe_YPZCqvAyg4YfaYEpcPYfv0G6YDrOLJAi8Pcc-iPk-4VZVcj1pRkb0sdP_eLipGjMh8o2SDb2ENb2cLTvmsQAuWn9M_aGdELAuri44YX_7XOnPJISjE34LQJ2hfx6k92qNVHXn_jWfkk8LOQBXJ53h-rc1yPaCf2NEnbet8oxjVNkeXeb-TgfabnWQ0bPzWRGliHE8rdX0Kyyi7d9StcpxQx84"
                      alt="Athletic football player in action pose holding a ball with intense focus"
                      fill
                  ...
                  <div className="relative z-20 -mt-12 flex flex-col p-6 pt-0">
                    <div className="flex justify-between items-end mb-4">
                      <div>
                        ...
                        <p className="text-sm text-text-grey">Quarterback &bull; Class of &apos;25</p>
                      </div>
                      <div className="h-12 w-12 rounded-full border-2 border-primary bg-surface-dark flex items-center justify-center">
                        <span className="font-bold text-white font-mono text-lg">98</span>
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-3 mb-6">
                      <div className="rounded bg-white/5 p-3 border border-white/5">
                        ...
                        <p className="text-xl font-bold text-primary font-mono">4.42s</p>
                      </div>
                      <div className="rounded bg-white/5 p-3 border border-white/5">
                        <p className="text-[10px] uppercase tracking-wider text-text-grey mb-1">GPA</p>
                        <p className="text-xl font-bold text-white font-mono">3.8</p>
                      </div>
                      <div className="rounded bg-white/5 p-3 border border-white/5">
                        <p className="text-[10px] uppercase tracking-wider text-text-grey mb-1">Vertical</p>
                        <p className="text-xl font-bold text-white font-mono">36&quot;</p>
                      </div>
                      <div className="rounded bg-white/5 p-3 border border-white/5">
                        <p className="text-[10px] uppercase tracking-wider text-text-grey mb-1">Offers</p>
                        <p className="text-xl font-bold text-white font-mono">12</p>
                      </div>
                    </div>
                    <Link href="/card/marcus-j" className="w-full rounded bg-primary py-2 text-sm font-bold text-black hover:bg-primary-hover text-center block">
                      View Full Profile
                    </Link>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-white/10">
            <div className="flex flex-col items-center gap-2 p-2">
              <span className="text-4xl lg:text-5xl font-bold text-primary font-mono">500+</span>
              <span className="text-sm font-medium uppercase tracking-wider text-text-grey">Colleges Active</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-2">
              <span className="text-4xl lg:text-5xl font-bold text-primary font-mono">10k+</span>
              <span className="text-sm font-medium uppercase tracking-wider text-text-grey">Athletes Verified</span>
            </div>
            <div className="flex flex-col items-center gap-2 p-2">
              <span className="text-4xl lg:text-5xl font-bold text-primary font-mono">98%</span>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="w-full lg:w-1/2">
              <div className="relative rounded-xl border border-white/10 bg-[#0A0A0A] overflow-hidden shadow-2xl">
                ...
                <div className="p-1">
                  <div className="w-full h-[300px] sm:h-[400px] relative rounded-lg overflow-hidden opacity-90">
                    <Image
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuCiaH6hfjjDnKeF5gXfDwgiwfh3sJo2gWMQLvWxXFUMGgPaWSxsABv0POM77EswpqwAi_GUIPUhFZUtRyuSlkP9lPeMIcepagvC69BOZlw-HL85bm1LT5nhO4-l_DRTvQ7DYBeV4SOH5TSk6Wc5zd4lkIjcVQJLS_UgkxSNEWBMrUhLPvpeUqLNkWgKHT2soBrLYAFZ0SE38mt26NAFtx0v4p-DTWl1RShpg0x5oNQRYGt8yWlHAPRvhy8LdLxeqlDgJIhwqPZhgRg"
                      alt="Dashboard interface screenshot showing charts, athlete list, and filtering options with a dark theme"
                      fill
      ...
      <section className="py-24 bg-surface-dark border-t border-white/5 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/signup" className="w-full sm:w-auto rounded-md bg-primary px-10 py-4 text-lg font-bold text-[#050505] transition-all hover:bg-primary-hover hover:scale-105 shadow-[0_0_20px_rgba(212,175,53,0.4)]">
              Create Free Athlete Account
            </Link>
            <Link href="/login" className="w-full sm:w-auto rounded-md border border-white/10 bg-white/5 px-10 py-4 text-lg font-bold text-white transition-all hover:bg-white/10 hover:border-white/20">
      ...
      <footer className="bg-background-dark border-t border-white/5 pt-16 pb-8">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-text-grey">&copy; 2024 RepMax Inc. All rights reserved.</p>
