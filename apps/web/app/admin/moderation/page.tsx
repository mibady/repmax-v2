...
const mockItems: ModerationItem[] = [
  {
    id: '1',
    user: { name: 'Sarah Smith', imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBLUaDI0wbk3c4w6PgfEj6X821qS55XpH94pKszab--nPo_oBy8Pnyxj929mgl294JRQog-qYDJD37CPy2PPDeDnd-2iCvfQ13wReU8lSqJrOCpbI0JDkZ8pIHdaVDErrQmcx2X0tBXYJJzCeZ29mZM9OV60Pps6uiHvMXBzoJV4YTIG4mP4fO_fdorJ0262UtIPYOPlm09ks5BHWz-uzHUoH_rtQNWjZlWLEZiKpSDevVEq38E7JwjzEZJz6GF9B6YsqLklwWONUc' },
    type: 'photo',
    flagReason: 'Nudity',
  ...
  {
    id: '2',
    user: { name: 'John Doe', imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDn9Z39YNKB6HRHJIgnnzVVgmYJxeieRYSjc6HAE3KZn-7DIdEi081bccC4WQax-78udhZ_c7emxDWo6Y3Al3bEsP_nt3l-XBtTIfkoe8s-ozCWBE5puRpui3BR4TYZmtLbUFAvqjBrtPE6KDRQNkM4PxHdgRAPHtHSFEMfQF3NSfihneEUIe_IvpkPdPzn6Ae2TyKLOydNPqZw4N43q4j7HhOkHVGwIomI3_J9G9GjwRN1xJjc4MY3vVefRj1aT9c6Q6P24lvWNEE' },
    type: 'bio',
    flagReason: 'Hate Speech',
    content: '"I really hate how this app works and everyone on it... honestly, people from [REDACTED GROUP] shouldn\'t even be allowed here."',
    reportedAgo: '1 day ago',
    matchConfidence: '98%',
  },
  {
    id: '3',
    user: { name: 'Mike Ross', imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBWaXXBwZTNSj4rijGYcVbtgyn3lW-Y6oZH2CZf8EGsvTHMtgq6wXk9b0oqM7zGhvSMWz7FtAaLiR3HL5TrpWoPisiFPrg8iR8eEtwKitUaWl2x4gv1g746HMrTPm_7LIlPS2aSvKpC5jk03RZPVIW13Bi6NLKidOr8MgJdV2dPaP6S2UFmkZD3U7AAc2CLWWzq_eQPMxjsFpl34CR8xrCIPqwrjo2xDl9iOdYceyJgxdedcL-9v0fLY1txqkst33iJoSdTs1LQBao' },
    type: 'film',
  ...
  {
    id: '4',
    user: { name: 'Crypto King', imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCi6D4D4wd06IqZ6rShVciX1L1UCVRWSfFAWTX9bNVFWC1OSWtgnqLsmkWgzIV_ycWZUgdesDCOotAT86KxZbjZzkb53_baJ8Q2uSXBI4Zm0oGnpm85GbxO3-0boV0YAIJ9SDGHyosn-9BpfLV1R_tISZTh29kyxhtQskOL5TidSJ0kqPLZxpSvGPOJCI7LCAlXSlCWzfvkYEsH75tYiBzkCX5ZHNumExRJedO5IZkpMEHacVt84YZG4D9SDm07qidIlyfxeBzbqVo' },
    type: 'photo',
    flagReason: 'Spam',
    reportedAgo: '30 mins ago',
  },
  {
    id: '5',
    user: { name: 'Jessica L.', imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCd4WcBNCmXWuaM5hwN-E0Iic13IrpAH1eZ-8bJrWUCsNXg87_S0WN6u5J08omyD-OBWYV04PC7WWEhI0sl_6oBR_fZKjJ33_H29oi7RatJozUG2UgTfplxcM-iXuZooDcogJpgIpKCmelhousnmYOxVXjymizpp389_C3KltHBhbPtF-5CEiofN5OSa3woyooSYui9PuTfqhCUjTw_pRiBaUtAmd1rr-tHpCTbzgMSNvY8Wyx5YquNG3mN_F2Dq_RHsNmXcB9PJB4' },
    type: 'bio',
    flagReason: 'PII / Doxing',
    content: '"Call me at 555-0192 if you want to hang out. My address is 123 Maple St..."',
        ...
        <aside className="hidden md:flex flex-col w-72 h-full border-r border-white/10 bg-[#121212] shrink-0">
          ...
          <nav className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-2">
            ...
            <Link href="/admin/moderation" className="flex items-center gap-3 px-4 py-3 bg-[#ef4343]/10 text-[#ef4343] rounded-lg transition-colors">
              ...
              <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-[#ef4343] text-[10px] font-bold text-white">12</span>
            </Link>
          ...
          <div className="flex flex-col border-b border-white/10 bg-[#050505]/80 backdrop-blur-md sticky top-0 z-20">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5">
              ...
              <div className="flex items-center gap-3">
                <div className="bg-red-500/10 border border-red-500/20 text-red-500 px-4 py-2 rounded-lg flex items-center gap-2">
                  ...
                  <span className="text-sm font-bold">12 items flagged</span>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 pb-4 flex flex-wrap gap-2 items-center">
              <div className="relative group">
                ...
                <select className="pl-9 pr-8 py-2 bg-[#1E1E1E] border-none rounded-lg text-sm font-medium text-slate-200 focus:ring-2 focus:ring-[#ef4343] outline-none appearance-none cursor-pointer">
                ...
                return (
                  <div key={item.id} className="bg-[#121212] border border-white/5 rounded-xl overflow-hidden shadow-sm flex flex-col group hover:border-[#ef4343]/30 transition-all duration-300">
                    ...
                    <div className="p-4 flex items-start justify-between border-b border-white/5 bg-[#1E1E1E]/30">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{ backgroundImage: `url('${item.user.imageUrl}')` }}
                        ></div>
                        <div>
                          <div className="flex items-center gap-2">
                            <h3 className="text-sm font-bold text-white">{item.user.name}</h3>
                            <span className="text-xs text-slate-500 font-mono">ID: #{item.id}492</span>
                          </div>
                    ...
                    <div className="p-4 flex items-center gap-2 mt-auto border-t border-white/5 bg-[#1E1E1E]/10">
                      <button className="flex-1 flex items-center justify-center gap-2 h-10 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 text-sm font-semibold transition-colors border border-green-500/20">
                        <span className="material-symbols-outlined text-[18px]">check_circle</span>
                        Approve
                      </button>
                      <button className="h-10 w-10 flex items-center justify-center rounded-lg bg-yellow-500/10 hover:bg-yellow-500/20 text-yellow-400 transition-colors border border-yellow-500/20" title="Warn User">
                        <span className="material-symbols-outlined text-[20px]">warning</span>
                      </button>
                      <button className="flex-1 flex items-center justify-center gap-2 h-10 rounded-lg bg-[#ef4343] hover:bg-red-600 text-white text-sm font-semibold transition-colors shadow-lg shadow-[#ef4343]/20">
