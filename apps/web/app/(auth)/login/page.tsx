...
<input className="w-full h-14 bg-input-bg text-white placeholder-gray-500 rounded-xl border border-transparent focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none px-4 transition-all duration-200" id="email" placeholder="coach@university.edu" type="email" />
</div>
{/*  Password Field  */}
<div className="flex flex-col gap-2">
<div className="flex justify-between items-center ml-1">
<label className="text-gray-300 text-sm font-medium" htmlFor="password">Password</label>
<Link className="text-primary text-sm hover:underline hover:text-primary/80 transition-colors" href="/">Forgot password?</Link>
</div>
<div className="relative flex items-center">
<input className="w-full h-14 bg-input-bg text-white placeholder-gray-500 rounded-xl border border-transparent focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none pl-4 pr-12 transition-all duration-200" id="password" placeholder="Enter your password" type="password" />
<button className="absolute right-4 text-gray-500 hover:text-primary transition-colors flex items-center justify-center" type="button">
<span className="material-symbols-outlined text-[20px]">visibility_off</span>
</button>
</div>
</div>
{/*  Sign In Button  */}
<button className="mt-2 w-full h-14 bg-primary hover:bg-yellow-600 text-black font-bold text-lg rounded-xl transition-all duration-200 shadow-[0_0_15px_rgba(212,175,53,0.2)] hover:shadow-[0_0_20px_rgba(212,175,53,0.4)]" type="submit">
                    Sign In
                </button>
</form>
{/*  Divider  */}
...
<button className="flex items-center justify-center gap-3 h-12 bg-input-bg hover:bg-[#252525] border border-gray-800 hover:border-gray-700 rounded-xl transition-all duration-200 group" type="button">
...
<p className="text-gray-400 text-sm">
                    ...
                    <Link className="text-primary font-semibold hover:underline hover:text-primary/80 transition-colors ml-1" href="/">Sign Up</Link>
</p>
</div>
</div>
</div>
