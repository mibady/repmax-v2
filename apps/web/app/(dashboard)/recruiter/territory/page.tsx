...
export default function TerritoryAssignmentsPage() {
  ...
  return (
    <div className="flex h-full min-h-0">
      ...
      <section className="w-full md:w-[45%] h-full flex flex-col relative border-l border-transparent md:border-[#262626]">
        {/* Sticky Header */}
        <header className="shrink-0 px-8 pt-8 pb-4 z-10 border-b border-white/5">
          <div className="flex flex-col gap-2">
