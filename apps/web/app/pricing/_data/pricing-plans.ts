    ...
    plans: [
      {
        ...
        ctaText: 'Get Started Free',
        features: ['Team Roster (up to 25)', 'Basic Dashboard', 'Student Athlete Profiles'],
      },
      {
        name: 'Premium',
        slug: 'hs-premium',
        annualSlug: 'hs-premium-annual',
        monthlyPrice: 49.99,
        annualPrice: 499.90,
        billingMode: 'subscription',
        description: 'For competitive programs',
        ctaText: 'Go Premium',
        highlighted: true,
        accentColor: 'primary',
        features: [
