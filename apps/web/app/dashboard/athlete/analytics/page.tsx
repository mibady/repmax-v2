    ...
    <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-display min-h-screen flex flex-col overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-surface-border bg-surface-dark/95 backdrop-blur supports-[backdrop-filter]:bg-surface-dark/60">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/" className="size-8 text-primary flex items-center">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link className="text-white font-medium hover:text-primary transition-colors border-b-2 border-primary py-5" href="/dashboard/athlete">Dashboard</Link>
            <Link className="text-gray-400 font-medium hover:text-white transition-colors" href="/dashboard/athlete/profile">Profile</Link>
            <Link className="text-gray-400 font-medium hover:text-white transition-colors" href="/dashboard/athlete/recruiting">Recruiting</Link>
            <Link className="text-gray-400 font-medium hover:text-white transition-colors" href="/dashboard/settings">Settings</Link>
          </nav>
          <div className="flex items-center gap-4">
      ...
      <footer className="border-t border-surface-border mt-8 py-8 bg-surface-dark">
        <div className="container mx-auto px-4 text-center text-gray-500 text-sm">
          <p>© 2025 RepMax Analytics. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
