...
<div className="bg-center bg-no-repeat bg-cover rounded-full size-12 ring-2 ring-primary/20" data-alt="Portrait of athlete Jaylen Washington" style={{backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAqPe_QIUhmiD0eCH7x7N2msrO8jpG2v0Z1It1Qvy3U4v2yMIh8UAg5kamDlvWUSLYr84u1j-hD5V_NK969Al8Dyyq7YQZ64kuky65iFU8LKh9Eno_A8evujMURvqvL9xapPLRLorU0fZ33NGOkhRKn-8VOz8F1JZ-y2ody9QH0OPikNkeetiqXS9mC6xz_cEJdKFk-i6E62eo-54Qvo7GowhXs-nQvra-P4uC_3b816nMCRElyeuE-tyMmvsAlgj6mnlWeSDJocyI')"}}>
</div>
<div className="flex flex-col overflow-hidden">
<h2 className="text-white text-sm font-semibold truncate">Jaylen W.</h2>
<p className="text-text-muted text-xs font-normal truncate">Class of 2024</p>
</div>
</div>
</div>
<nav className="flex-1 px-4 flex flex-col gap-1 overflow-y-auto">
<Link className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary text-black transition-colors group" href="/">
<span className="material-symbols-outlined fill text-[20px]">dashboard</span>
<span className="text-sm font-semibold">Dashboard</span>
</Link>
<Link className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-muted hover:bg-white/5 hover:text-white transition-colors group" href="/">
...
<span className="ml-auto bg-accent-purple/20 text-accent-purple text-[10px] font-bold px-1.5 py-0.5 rounded data-point">2</span>
</Link>
<Link className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-text-muted hover:bg-white/5 hover:text-white transition-colors group" href="/">
...
<Link className="flex items-center px-3 py-2.5 rounded-lg text-white hover:bg-white/5 transition-colors" href="/">
<span className="text-sm font-medium">Team Dashboard</span>
</Link>
<Link className="flex items-center px-3 py-2.5 rounded-lg text-white hover:bg-white/5 transition-colors" href="/">
<span className="text-sm font-medium">Club Dashboard</span>
</Link>
<div className="h-px bg-[rgba(255,255,255,0.08)] my-1.5 mx-1"></div>
<Link className="flex items-center gap-2 px-3 py-2 rounded-lg text-primary hover:bg-primary/10 transition-colors" href="/">
<span className="material-symbols-outlined text-[18px]">add</span>
<span className="text-sm font-bold">Add another role</span>
</Link>
</div>
</div>
...
<span className="text-xs font-bold text-accent-purple uppercase tracking-wider">West Zone</span>
</div>
...
<div>
<h1 className="text-3xl font-bold text-white mb-2">Welcome back, Jaylen</h1>
...
<span className="text-xs font-bold text-accent-purple uppercase tracking-wider">Zone Pulse: West</span>
</div>
<h3 className="text-2xl font-bold text-white mb-1">Recruiting activity is High</h3>
<p className="text-gray-300 text-sm max-w-lg">Coaches from the PAC-12 region are actively scouting running backs this week. Keep your profile updated.</p>
</div>
<button className="relative z-10 bg-white text-black hover:bg-gray-100 px-5 py-2.5 rounded-lg text-sm font-bold transition-colors whitespace-nowrap">
                        View Intel Report
                    </button>
...
<span className="text-green-500 text-xs font-bold bg-green-500/10 px-2 py-0.5 rounded flex items-center gap-1 data-point">
<span className="material-symbols-outlined text-[12px]">trending_up</span> +12%
                                    </span>
</div>
<div className="flex items-end justify-between">
<div className="text-4xl font-bold text-white data-point">23</div>
...
<div className="text-4xl font-bold text-white data-point">3</div>
<div className="mb-1 text-sm text-text-muted">Coaches watching</div>
</div>
<div className="mt-4 flex -space-x-2 overflow-hidden">
<img alt="Coach 1" className="inline-block size-8 rounded-full ring-2 ring-surface-dark" data-alt="Headshot of a coach" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCpFOEUz_rfWWSVZf8V8mFWpvSX0XbEvnGhfEPVxD3mYrqKA6J94E78iBa_bR1caG28xt4BCjjnmdpZ8gfWL2lqcqVjfRncL7V0MxJBJxQQLl315vZyu2h6k9L5D4eNTwqVSBKB6cji7NJkO3WIoWyV4PeQrLPwNIgFa36RdDTOOR035pkGUVlwoADx0noxixr0W7lVDf9paHXe5l3fXR4SoKoRwegF0Uejyfdrq-vkbtjy7k-3snSTmQeCc6x5BHmksTTT1Aer9Qo" />
<img alt="Coach 2" className="inline-block size-8 rounded-full ring-2 ring-surface-dark" data-alt="Headshot of a coach" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDNGSJP1Yy-eGxpCf6rPGNkezMVwK3g54iNrZM7cB9fHuv-EibYRsb8QHQ8-GaKbav4l_sEg685mD9v1qG2ZjN2GVITPW6x-PvsMxKinv_-Rdoo8lBibLP6ZdQqI4zs63KKW99NdFI2YHk995W3BS6qigKbT7xdl8JQxCeEeReOCOnPNehXmaJPjzywBZMG3wkbqimcrmxT-hWumt54hIqz2zwbSxJa_UMpkeskIUFNXHe8ZZd5b1kEUnLU02ZPMCQi4Jc_oBe-WYc" />
<div className="inline-block size-8 rounded-full ring-2 ring-surface-dark bg-[#333] flex items-center justify-center text-xs font-medium text-white">+1</div>
</div>
</div>
</div>
...
<div className="p-0">
<div className="flex items-center p-4 border-b border-[#333] hover:bg-white/5 transition-colors group">
<div className="flex-shrink-0 w-16 text-center">
<div className="text-xs text-red-400 font-bold uppercase">Feb</div>
<div className="text-xl font-bold text-white data-point">07</div>
</div>
<div className="ml-4 flex-1">
<div className="text-sm font-bold text-white">National Signing Day</div>
<div className="text-xs text-text-muted">NCAA Wide Event</div>
</div>
<span className="px-2 py-1 rounded bg-red-500/10 text-red-400 text-[10px] font-bold uppercase border border-red-500/20">High Priority</span>
</div>
<div className="flex items-center p-4 border-b border-[#333] hover:bg-white/5 transition-colors group">
<div className="flex-shrink-0 w-16 text-center">
<div className="text-xs text-text-muted font-bold uppercase">Mar</div>
<div className="text-xl font-bold text-white data-point">15</div>
</div>
<div className="ml-4 flex-1">
<div className="text-sm font-bold text-white">Junior Day - State Univ.</div>
<div className="text-xs text-text-muted">Official Visit</div>
</div>
<span className="px-2 py-1 rounded bg-[#333] text-text-muted text-[10px] font-bold uppercase border border-[#444]">Upcoming</span>
</div>
<div className="flex items-center p-4 hover:bg-white/5 transition-colors group">
<div className="flex-shrink-0 w-16 text-center">
<div className="text-xs text-text-muted font-bold uppercase">Apr</div>
<div className="text-xl font-bold text-white data-point">22</div>
</div>
<div className="ml-4 flex-1">
<div className="text-sm font-bold text-white">Spring Showcase Camp</div>
<div className="text-xs text-text-muted">Las Vegas, NV</div>
</div>
</div>
</div>
</div>
...
<div className="absolute inset-0 bg-cover bg-center" data-alt="Action shot of athlete running with football" style={{backgroundImage: "url('https://images.unsplash.com/photo-1566577134770-3d85bb3a9cc4?w=400&h=600&fit=crop')"}}>
...
<h2 className="text-2xl font-black text-white uppercase italic tracking-tighter leading-none">Washington</h2>
<div className="text-3xl font-black text-primary data-point italic">RB</div>
</div>
<div className="flex items-center gap-1 mb-3">
<span className="material-symbols-outlined text-primary fill text-[18px]">star</span>
<span className="material-symbols-outlined text-primary fill text-[18px]">star</span>
<span className="material-symbols-outlined text-primary fill text-[18px]">star</span>
<span className="material-symbols-outlined text-[#444] text-[18px]">star</span>
<span className="material-symbols-outlined text-[#444] text-[18px]">star</span>
</div>
...
<div className="text-sm font-bold text-white data-point">5'10"</div>
</div>
<div>
<div className="text-[10px] text-gray-400 uppercase">Weight</div>
<div className="text-sm font-bold text-white data-point">185</div>
</div>
<div>
<div className="text-[10px] text-gray-400 uppercase">40YD</div>
<div className="text-sm font-bold text-white data-point">4.45</div>
</div>
</div>
</div>
</div>
<div className="p-3 grid grid-cols-2 gap-3">
<button className="flex items-center justify-center gap-2 bg-primary text-black font-bold py-2 rounded-lg text-sm hover:bg-primary/90 transition-colors">
...
<button className="w-full flex items-center justify-between p-3 rounded-lg bg-[#2A2A2E] hover:bg-[#333] border border-transparent hover:border-[#444] transition-all group text-left">
