      ...
      <div className="flex min-h-screen w-full">
        ...
        <aside className="hidden lg:flex w-64 flex-col border-r border-[#333333] bg-[#050505] fixed h-full z-20">
          ...
          <nav className="flex-1 overflow-y-auto py-6 px-3 flex flex-col gap-2">
            ...
            <Link href="/dashboard/recruiter/pipeline" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#A1A1AA] hover:bg-[#1F1F22] hover:text-white transition-colors group">
              <span className="material-symbols-outlined text-[#A1A1AA] group-hover:text-[#D4AF37]">filter_alt</span>
              <span className="text-sm font-medium">Pipeline</span>
            </Link>
            <Link href="/dashboard/recruiter/prospects" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#A1A1AA] hover:bg-[#1F1F22] hover:text-white transition-colors group">
            ...
            <Link href="/dashboard/recruiter/communications" className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[#A1A1AA] hover:bg-[#1F1F22] hover:text-white transition-colors group">
          ...
          <div className="p-4 border-t border-[#333333]">
            <Link href="/dashboard/settings" className="flex items-center gap-3 rounded-lg px-3 py-2 text-[#A1A1AA] hover:text-white transition-colors">
