...
const navItems = [
  { icon: 'view_kanban', label: 'Pipeline', href: '/dashboard/recruiter/pipeline', active: true },
  { icon: 'groups', label: 'Athletes', href: '/dashboard/recruiter/prospects', active: false },
  { icon: 'campaign', label: 'Campaigns', href: '/dashboard/recruiter/campaigns', active: false },
  { icon: 'chat_bubble', label: 'Messages', href: '/dashboard/messages', active: false },
  { icon: 'analytics', label: 'Analytics', href: '/dashboard/recruiter/analytics', active: false },
];
    ...
    <div className="flex h-screen w-full bg-[#050505] text-slate-200 font-sans overflow-hidden selection:bg-primary/30 selection:text-primary">
      ...
      <div className="w-64 flex-shrink-0 bg-[#0a0a0a] border-r border-white/5 flex flex-col justify-between p-4 h-full">
        ...
        <div className="flex flex-col gap-2">
          <Link href="/dashboard/settings" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition-all">
