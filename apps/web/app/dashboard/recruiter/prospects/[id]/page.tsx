...
function LoadingSkeleton() {
  return (
    <div className="bg-slate-100 dark:bg-[#201d12] text-slate-900 dark:text-white min-h-screen flex flex-col font-sans">
      <div className="flex-1 flex justify-center py-6 px-4 md:px-8 lg:px-12 xl:px-20">
...
function ErrorState({ error, onRetry }: { error: Error; onRetry: () => void }) {
  return (
    <div className="bg-[#201d12] text-white min-h-screen flex items-center justify-center">
      ...
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#433d28] px-6 py-3 bg-[#201d12] sticky top-0 z-50">
        ...
        <div className="flex flex-1 justify-end gap-6 items-center">
          <div className="hidden lg:flex items-center gap-8 mr-4">
            <Link className="text-white text-sm font-medium hover:text-primary transition-colors" href="/dashboard/recruiter">
              Dashboard
            </Link>
            <Link className="text-primary text-sm font-bold" href="/dashboard/recruiter/prospects">
              Prospects
            </Link>
            <Link className="text-white text-sm font-medium hover:text-primary transition-colors" href="/dashboard/recruiter/pipeline">
              Pipeline
            </Link>
            <Link className="text-white text-sm font-medium hover:text-primary transition-colors" href="/dashboard/settings">
              Settings
            </Link>
          </div>
        </div>
