...
function EmptyState() {
  return (
    <div className="flex-1 flex items-center justify-center bg-[#050505] p-6">
      <div className="text-center max-w-md">
        ...
        <Link
          href="/dashboard/recruiter/board"
    ...
    <header className="flex-none flex items-center justify-between whitespace-nowrap border-b border-solid border-[#2A2A2E] bg-[#1F1F22] px-6 py-3">
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <Link href="/dashboard/recruiter/search" className="text-gray-400 hover:text-white text-sm font-medium transition-colors">Athletes</Link>
          <Link href="/dashboard/recruiter/compare" className="text-white text-sm font-medium transition-colors">Compare</Link>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="h-8 w-8 rounded-full bg-[#2A2A2E] border border-[#333] flex items-center justify-center">
    ...
    <div className="bg-[#050505] text-white font-[family-name:var(--font-inter)] overflow-hidden h-screen flex flex-col">
      ...
      <main className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        {availableAthletes.length > 3 && (
          <div className="flex-none px-6 py-4 border-b border-[#2A2A2E] bg-[#1F1F22]">
            <div className="max-w-[1400px] mx-auto w-full">
