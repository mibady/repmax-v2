...
export default function CoachHero({ coachName, school, coachAvatarUrl, activeTab, metrics, isLoading }: CoachHeroProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative z-10 px-8 pt-6 pb-0 flex gap-6">
        ...
        {/* Right column: coach/team images full height */}
        <div className="relative flex flex-col items-center self-stretch">
          ...
          {/* Images row — square tiles filling banner height */}
          <div className="flex items-stretch gap-4 flex-1">
            {/* Team Logo */}
            <div className="aspect-square h-full rounded-xl bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden">
              <span className="material-symbols-outlined text-white/25 text-[56px]">shield</span>
            </div>
            {/* Coach Headshot */}
            <div className="aspect-square h-full rounded-2xl bg-white/5 border-[3px] border-primary/50 flex items-center justify-center overflow-hidden shadow-lg shadow-primary/10">
              {coachAvatarUrl ? (
          ...
          <div className="mt-2 mb-1">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-green-500/15 border border-green-500/30 text-green-400 text-xs font-semibold whitespace-nowrap">
